...
export const U_SUPERPROF = "https://www.superprof.fr/cours-distance-developpement-web-frameworks-javascript-reactjs-nodejs.html";
...
export const T_OG_DESC = `
    ...
    Que vous soyiez une entreprise ou un particulier, je mets mon expertise et mes compétences à votre service.
`;